...
class AbstractManager(QObject, ABC):
    """
    抽象管理器基类
    ...
    Attributes:
        dic_signals: 管理器信号字典 {str_signal_name: pyqtSignal}
        logger: 日志记录器
    ...
    # 用户消息信号 - 所有Manager共享
    # ============================================================
    sig_info = pyqtSignal(str)      # 一般信息
    sig_warning = pyqtSignal(str)   # 警告
    sig_error = pyqtSignal(str)     # 错误
    sig_success = pyqtSignal(str)   # 成功
    ...
    def __init__(self, parent: Optional[QObject] = None):
        ...
        self.dic_signals: Dict[str, pyqtSignal] = {}
        self.dic_signals_msg: Dict[str, pyqtSignal] = {}
    ...
    def _connect_signals_to_slot(self, slot: pyqtSlot):
        """
        连接所有子类信号到指定的槽函数
        """
    ...
    def get_signal(self, str_name_signal: str) -> pyqtSignal:
        """
        获取指定名称的信号
    ...
    def get_signal_all(self) -> Dict[str, pyqtSignal]:
        """
        获取所有信号的字典
